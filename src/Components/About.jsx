        ...
        <>
            <div className="container-fluid about-container">
                ...
                {/* <div className="row mb-5">
                    <div className="col-6 bg-primary col-sm-12 col-lg-6" style={{ padding: "125px 135px 125px 10px" }}>
                        <div className="mb-3">
                    ...
                    <div className="col-6 bg-dark col-sm-12 col-lg-6" style={{ padding: "0 10px 0 55px" }}>
